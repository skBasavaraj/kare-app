                ...
                Material(
                    ...
                    child:  Row(
                      children: [
                        ...
                        Text("Register",style: GoogleFonts.jost(fontSize: 25,color: Colors.white),)
                      ],
                    ),
                    color:Colors.blue
...
*/
                       ...
                       isExpanded: true,
                        ...
                        AppButton(
                          ...
                          onTap: () async {
                            // signUp();
                            if(emailCont.text.isNotEmpty&&contactNumberCont.text.isNotEmpty&&dOBCont.text.isNotEmpty&&firstNameCont.text.isNotEmpty) {
                              var info = await ApiService.register(
                                  filePath!,
                                  firstNameCont.text.validate(),
                                  lastNameCont.text.validate()
                                  ,
                                  emailCont.text.validate(),
                                  contactNumberCont.text,
                                  cityName!,
                              ...
                              if (info!.error == "001") {
                                snackBar(context, title: info.message!,
                              ...
                              snackBar(context, title: "Please fill out all fields!",backgroundColor: Colors.red.shade200);
                            }
                          },
                          color: primaryColor,
                          padding: EdgeInsets.all(10),
                          child: Text( 'Submit', style: GoogleFonts.jost(fontSize: 25,color: Colors.white)),
                        ),
                        /*24.height,
